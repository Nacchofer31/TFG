...
\begin{table}[H]
  ...
  Una vez introducida la términología propia del sistema, para un mayor entendimiento del contexto del mismo, se represesenta un  
  diagrama de clases de acuedo a las reglas clásicas UML, como se pude visualizar en la Figura~\ref{fig:dom1}.
